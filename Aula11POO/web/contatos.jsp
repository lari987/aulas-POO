<%-- 
    Document   : contatos.jsp
    Created on : 25 de out. de 2021, 08:46:16
    Author     : Larry
--%>
    ...
    <body>
        ...
        <form>
            <fieldset>
                ...
                <input type="number" name="nascimento.dia"/>/
                <input type="number" name="nascimento.mes"/>/
                <input type="number" name="nascimento.ano"/>
                <br/><br/>
